...
######################################
replicates.data.raw <- read.table("~/Documents/cost_theory_workingspace/DATA/arabidopsis/leaves/transcriptome/transcript_level.txt", h=T, fill=T, sep="\t")
...
######################################
replicates.data.raw <- read.table("~/Documents/cost_theory_workingspace/DATA/arabidopsis/leaves/proteome/protein_level.txt", h=T, fill=T, sep="\t")
replicates.data <- replicates.data.raw[, -1]
...
######################################
replicates.data.raw <- read.table("~/Documents/cost_theory_workingspace/DATA/cyanobacteria/transcriptome/transcript_level.txt", h=T, fill=T, sep="\t")
replicates.data <- replicates.data.raw[, -1]
...
######################################
replicates.data.raw <- read.table("~/Documents/cost_theory_workingspace/DATA/cyanobacteria/proteome/protein_level.txt", h=T, fill=T, sep="\t")
replicates.data <- replicates.data.raw[, -1]
...
######################################
replicates.data.raw <- read.table("~/Documents/cost_theory_workingspace/DATA/ostreococcus/transcriptome/transcript_level.txt", h=T, fill=T, sep="\t")
replicates.data <- replicates.data.raw[, -1]
...
######################################
replicates.data.raw <- read.table("~/Documents/cost_theory_workingspace/DATA/ostreococcus/proteome/protein_level.txt", h=T, fill=T, sep="\t")
replicates.data <- replicates.data.raw[, -1]
...
# Export as pdf image
pdf("~/Documents/cost_theory_workingspace/supplementary_information/PC1_PC2.pdf", height = 12, width = 7)
...
read_docx(path = "~/Documents/cost_theory_workingspace/figures_rmd.docx") %>%
  ...
  cursor_reach(keyword = "##PCA_pc1_pc2_biological_replicates##") %>%
