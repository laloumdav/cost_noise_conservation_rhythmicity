...
spearman.cor.test <- cor.test(tot.data$tau.mean, 
                             tot.data$nb.rhythmic.tissues, method = "spearman")
...
table.tot <- rbind(table.tot, data.frame(species = "mouse",
                                         ...
                                         parameters = "tau VS nb rhythmic tissues",
...
#pearson.cor.test <- cor.test(tot.data$tau.mean, 
#                             tot.data$nb.rhythmic.tissues, method = "pearson", na.rm = TRUE)
spearman.cor.test <- cor.test(tot.data$tau.mean, 
                              tot.data$nb.rhythmic.tissues, method = "spearman")

length(tot.data$tau.mean)
...
table.tot <- rbind(table.tot, data.frame(species = "mouse",
                                         omics = "protein", 
                                         technique = "SILAC",
                                         `nb tissues` = length(unique(full.dataframe$tissue)),
...
write.csv(table.tot, "~/Documents/cost_theory_workingspace/Table2.csv", quote = F, row.names = FALSE)
library(xtable)
print(xtable(table.tot, type = "latex"), file = "~/Documents/cost_theory_workingspace/Table2.tex", include.rownames=FALSE)
